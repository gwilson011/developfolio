...
const LOCATION_DOT_X = 58; // % from left edge
const LOCATION_DOT_Y = 47; // % from top edge
const MOBILE_LOCATION_DOT_X = 58; // % from left edge
const MOBILE_LOCATION_DOT_Y = 41; // % from top edge
