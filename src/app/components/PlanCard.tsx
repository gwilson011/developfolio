                ...
                {onLoadPlan && (
                    <div className="flex flex-row gap-2">
                        <button
                            ...
                            disabled={isLoading}
                            className="flex px-3 pt-3 pb-1 bg-white text-black font-pixel items-center justify-center text-xs hover:bg-gray-100 disabled:bg-gray-300 disabled:cursor-not-allowed border-default"
                        >
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="flex px-3 pt-3 pb-1 bg-black text-white font-pixel items-center justify-center text-xs hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed border-default"
                        >
